      ...
      <div className='block-content'>
        <article className='article'>
          ...
          <section className='description-container'>
            ...
            <Image style={{ marginLeft: '0' }} src="smc_stakeholders.png" width={1060} height={707} alt='SMC Partnerships' />

            <p> As one of the largest and most diversified
              conglomerates in the Philippines, SMC owns
              businesses and has investments in various
              sectors that affect the everyday lives of
              the Filipino people. A significant part of our
              sustainability philosophy revolves around
              tackling pressing problems being encountered
              by our stakeholders and how our businesses
              can contribute to solving these problems.
              At the same time, we recognize that being a
              sustainable enterprise boosts business
              performance and enhances shareholder value.
            </p>

            <p>We ensure that we are serving the needs of
              our stakeholders by constantly engaging with
              them in open dialogue and in various means of
              effective communication. At the same time, we
              continue to benchmark with the best practices
              of our peers, locally and globally, to further
              strengthen our ESG performance.
            </p>
