      ...
      <div className='block-content'>
        <article className='article'>
          <section className='description-container'>
            ...
            <Image style={{ borderRadius: '0' }} src="ghg_emisson.png" width={431} height={201} alt='15.8 GHG Emission' />
            ...
            <Image style={{ borderRadius: '0' }} src="combined_bess.png" width={430} height={192} alt='Combined Bess Project' />
            ...
            <p>In February and August 2022, we obtained a
              ...
              Currently, the Bataan Solar Project is in the predevelopment stage.</p>
            ...
            <Image src="san_roque_smc.png" width={1150} height={702} alt='SMC San Roque' />
            ...
            <Image style={{ borderRadius: '0' }} src="non_ghg_table.png" width={414} height={360} alt='Non-Ghg Emissions' />
            ...
            <Image style={{ borderRadius: '0' }} src="ghg_technology_table.png" width={568} height={364} alt='Technology Description Table' />

            <Image src="lamao_limay.png" width={1150} height={702} alt='Lamao Limay' />

            <h3 className='green'>Charting a low-carbon future</h3>
            ...
            <p>As nations around the world set ambitious goals to
              transition to renewables, demand for these largescale energy storage systems will grow. BESS
