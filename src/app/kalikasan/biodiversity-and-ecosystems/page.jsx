      ...
      <div className='block-content'>
        <article className='article'>
          <section className='description-container'>
            ...
            <Image src="CoralRescue.png" width={854} height={641} alt='Coral Rescue' />
            <h3 className='blue'>Coral reef rescue</h3>

            <Image src="CoralRescue2.png" width={943} height={612} alt='Coral Rescue' />
            ...
            <Image src="GreenForGood.png" width={1150} height={669} alt='Green for Good' />
            ...
            <Image src="giving.png" width={1150} height={665} alt='Casting a safety net ' />
            ...
            <Image src="unboxing.png" width={1150} height={665} alt='Casting a safety net' />
            ...
            <Image src="plant.png" width={1150} height={665} alt='Taking concrete  steps' />
            ...
            <ol>
              <li>
                ...
                <Image src="MonitoringTeam_.png" width={1150} height={863} alt='Monitoring Team' />
                ...
                <Image src="BangolCanitIbaloiSamahangTribuKaunlaran.png" width={1150} height={766} alt='Bangol Canit Ibaloi Samahang Tribu Kaunlaran' />
                ...
                <Image src="ArborDayandEnvironmentalMonth.png" width={1150} height={767} alt='NCC celebrated Arbor Day and Environment Month ' />
              ...
              <li>
                ...
                <Image src="JavaSparrow.png" width={1150} height={863} alt='NCC celebrated Arbor Day and Environment Month ' />
                ...
                <Image src="PhilippineCollaredDove.png" width={1150} height={874} alt='NCC celebrated Arbor Day and Environment Month ' />
              ...
              <li>
                ...
                <ol type='a'>
                  ...
                  <li><b>Siltation Pond Efficiency</b>
                    ...
                    <Image src="MMT_IEC.png" width={1150} height={862} alt='NCC celebrated Arbor Day and Environment Month ' />
