      ...
      <div className='block-content'>
        <article className='article'>
          <section className='description-container'>
            ...
            <Image style={{ borderRadius: '0' }} src="energy_operatoinal_spending.png" width={430} height={189} alt='Combined Bess Project' />
            ...
            <Image style={{ borderRadius: '0' }} src="energy_intensity_ratio.png" width={430} height={190} alt='Combined Bess Project' />
            ...
            <Image src="flares_to_fuel.png" width={1150} height={819} alt='Combined Bess Project' />
            ...
            <Image style={{ borderRadius: '0' }} src="water_consumption.png" width={431} height={216} alt='Water Consumption' />
            ...
            <Image style={{ borderRadius: '0' }} src="water_recycled.png" width={440} height={197} alt='Water Recycled and Reused' />
            ...
            <Image src="RevivingAilingRvers.png" width={1150} height={703} alt='Reviving our ailing rivers' />
