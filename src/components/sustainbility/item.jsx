...
export default function SustainabilityItem({ isInView }) {
  ...
  return (<>
    ...
    <div className={`wrap-item kalinga ${isActive.Kalinga ? 'zIndex5' : ''} `}  >
      ...
      <div className='desc'>
        <h3 className='label' onClick={() => handleItemClick('Kalinga')}>
          <div className='custom-arrow'>
            <motion.svg width="103" height="65" viewBox="0 0 103 65" fill="none" xmlns="http://www.w3.org/2000/svg">
              <motion.path
                variants={variants_3}
                initial="initial"
                animate={isInView ? "open" : "closed"}

                d="M100 13.1769C100 13.1769 76.5 -8.32311 45.5 11.1769C14.5 30.6769 16.5 61.6769 16.5 61.6769M16.5 61.6769C16.5 61.6769 25.5 49.1769 29.5 45.1769C33.5 41.1769 34.5 40.6769 34.5 40.6769M16.5 61.6769C16.5 61.6769 12.5 58.1769 8.5 53.6769C4.5 49.1769 3 44.6769 3 44.6769" stroke="#F58232" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
            </motion.svg>
          </div>
          ...
          <div className='toggle-button'>
            {isActive.Kalinga ?
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512">
                <path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" fill="#2E2E2F" />
              </svg>
              :
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512">
        ...
        <motion.p
          variants={variants_2}
          animate={isActive.Kalinga ? "open" : "closed"}
          className='text'> We protect and nurture the environment, through urgent climate action, efficient resource management, and a circular economy approach.</motion.p>
      </div>
    </div>
    ...
    <div className={`wrap-item kalikasan  ${isActive.Kalikasan ? 'zIndex5' : ''}`}>
      ...
      <div className='desc'>
        <h3 className='label' onClick={() => handleItemClick('Kalikasan')}>
          <div className='toggle-button' >
            {isActive.Kalikasan ?
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512">
                <path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" fill="#2E2E2F" />
              ...
              :
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512"><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" fill="#2E2E2F" /></svg>
            }
          </div>
          Kalikasan
          <div className='custom-arrow'>
            <motion.svg width="103" height="65" viewBox="0 0 103 65" fill="none" xmlns="http://www.w3.org/2000/svg">
              <motion.path
                ...
                initial="initial"
                animate={isInView ? "open" : "closed"}
                d="M3 13.1769C3 13.1769 26.5 -8.32311 57.5 11.1769C88.5 30.6769 86.5 61.6769 86.5 61.6769M86.5 61.6769C86.5 61.6769 77.5 49.1769 73.5 45.1769C69.5 41.1769 68.5 40.6769 68.5 40.6769M86.5 61.6769C86.5 61.6769 90.5 58.1769 94.5 53.6769C98.5 49.1769 100 44.6769 100 44.6769" stroke="#55B047" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
            </motion.svg>
    ...
    <div className={`wrap-item kasaganahan  ${isActive.Kasaganahan ? 'zIndex5' : ''}`}>
      ...
      <div className='desc'>
        <h3 className='label' onClick={() => handleItemClick('Kasaganahan')}>
          <div className="custom-arrow">
            <motion.svg width="47" height="27" viewBox="0 0 47 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <motion.path
                variants={variants_3}
                initial="initial"
                animate={isInView ? "open" : "closed"}
                d="M44 17.5C44 17.5 44 15.5 23.5 12C3 8.49999 3 9.99999 3 9.99999M3 9.99999C3 9.99999 10 6 16 4.5C22 3 29.5 3 29.5 3M3 9.99999C3 9.99999 8.5 13 14 17.5C19.5 22 21 24 21 24" stroke="#00A4D6" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
            </motion.svg>
        ...
        <motion.p
          variants={variants_2}
          animate={isActive.Kasaganahan ? "open" : "closed"}
          className='text'>We promote inclusive
          economic growth and
