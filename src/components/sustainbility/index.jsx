      ...
      <div className='block-content'>
        ...
        <div className='wrapper' ref={ref}>
          <div className='wrap-item kalinga'>
            ...
            <div className='desc'>
              <p className='label'>Kalinga</p>
              <p className='sub-label'>Good for People</p>
              <p> We protect and nurture the environment, through urgent climate action, efficient resource management, and a circular economy approach.</p>
            </div>
          </div>
          ...
          <div className='wrap-item kasaganahan'>
            ...
            <div className='desc'>
              <p className='label'>Kasaganahan</p>
