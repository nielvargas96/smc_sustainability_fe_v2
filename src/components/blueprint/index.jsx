              ...
              <div className='description'>
                ...
                <div className='blueprint-list'>
                  ...
                  <div className='blueprint-item'>
                    <div className='icon-img'>
                      <svg width="60" height="60" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M100 200C155.228 200 200 155.228 200 100C200 44.7717 155.228 0 100 0C44.7717 0 0 44.7717 0 100C0 155.228 44.7717 200 100 200Z" fill="#F58232" />
                        <path d="M89.3286 155.866L88.695 138.128C88.695 138.128 92.4962 134.327 93.1297 129.259C93.7632 124.19 89.9621 120.389 88.0615 119.122C86.161 117.855 77.9252 114.688 73.4905 110.253C69.0558 105.818 69.6894 102.228 66.5218 100.116C63.3541 98.0048 60.1865 100.75 60.1865 102.651" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <path d="M109.671 155.866L110.305 138.128C110.305 138.128 106.504 134.327 105.87 129.259C105.237 124.19 109.038 120.389 110.938 119.122C112.839 117.855 121.075 114.688 125.509 110.253C129.944 105.818 129.311 102.228 132.478 100.116C135.646 98.0048 138.813 100.75 138.813 102.651" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <path d="M85.5274 65.2727C85.5274 65.2727 74.124 65.9062 74.124 70.9744C74.124 76.0426 74.124 80.4773 74.124 83.0113C74.124 85.5454 78.5587 86.179 78.5587 86.179M78.8106 74.142V101.185" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                        <path d="M115.936 65.2727C115.936 65.2727 127.34 65.9062 127.34 70.9744C127.34 76.0426 127.34 80.4773 127.34 83.0113C127.34 85.5454 122.905 86.179 122.905 86.179M122.653 74.142V101.185" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                        <rect x="80.6921" y="50.3011" width="8.40341" height="10.9375" rx="3.5" stroke="white" strokeWidth="3" />
                        <rect x="95.8967" y="46.5" width="8.40341" height="10.9375" rx="3.5" stroke="white" strokeWidth="3" />
                        <rect x="112.368" y="50.3011" width="8.40341" height="10.9375" rx="3.5" stroke="white" strokeWidth="3" />
                        <path d="M92.4962 83.6449C92.4962 83.6449 88.6951 83.0113 88.6951 79.8437C88.6951 76.6761 88.6951 72.875 88.6951 67.8068C88.6951 62.7386 97.5644 61.4716 100.732 61.4716C103.9 61.4716 112.135 62.7386 112.135 67.8068C112.135 72.875 112.135 76.6761 112.135 79.8437C112.135 83.0113 108.334 83.6449 108.334 83.6449M93.1297 71.6079V100.75M107.701 71.6079V100.75M100.732 83.0113V100.75" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                      </svg>
                    </div>
                    <div className='info'>
                      <span className='label'><b className='orange'>Kalinga</b> <i>Good for People</i></span>
                      <div className='text'>
                        <p>3. At least 15 million people uplifted by 2030</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='blueprint-item'>
                    <div className='icon-img'>
                      <svg width="60" height="60" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M100 200C155.228 200 200 155.228 200 100C200 44.7717 155.228 0 100 0C44.7718 0 0 44.7717 0 100C0 155.228 44.7718 200 100 200Z" fill="#00A4D6" />
                        <path d="M144.57 60.975C144.57 60.975 146.688 60.2693 148.805 62.3866C151.857 65.4392 148.099 68.7383 148.099 68.7383L129.044 87.7935C129.044 87.7935 132.79 85.0118 136.101 84.9705C138.887 84.9358 141.512 87.0878 141.042 88.4993C140.571 89.9108 138.533 90.069 133.278 93.4395C128.552 96.4711 123.149 102.838 116.34 104.026C105.813 105.861 100.108 99.0855 100.108 99.0855C100.108 99.0855 94.4622 93.4395 94.4622 84.9705C94.4622 77.2073 99.4024 73.7076 103.637 68.0325C107.871 62.3575 109.283 56.7406 111.4 57.4463C113.122 58.0204 114.179 61.6808 113.517 64.5038C112.691 68.0325 108.577 72.9728 108.577 72.9728L129.044 51.8004C129.044 51.8004 131.867 48.2717 135.396 51.0946C138.924 53.9176 135.396 57.4463 135.396 57.4463" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M122.692 70.1497L139.63 53.2118C139.63 53.2118 142.453 49.683 145.982 52.506C149.511 55.329 145.982 58.8578 145.982 58.8578L128.338 76.5015" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                        <path d="M138.561 144.475C138.561 144.475 139.256 146.595 137.128 148.702C134.06 151.739 130.78 147.964 130.78 147.964L111.823 128.811C111.823 128.811 114.585 132.572 114.609 135.883C114.63 138.669 112.464 141.283 111.055 140.805C109.646 140.327 109.499 138.289 106.155 133.017C103.148 128.275 96.8079 122.84 95.6555 116.025C93.874 105.489 100.679 99.818 100.679 99.818C100.679 99.818 106.354 94.201 114.822 94.2443C122.586 94.2841 126.06 99.2421 131.713 103.506C137.367 107.769 142.976 109.209 142.26 111.323C141.677 113.042 138.011 114.08 135.191 113.404C131.667 112.559 126.748 108.421 126.748 108.421L147.815 128.995C147.815 128.995 151.329 131.836 148.488 135.351C145.647 138.865 142.137 135.318 142.137 135.318" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M129.498 122.55L146.349 139.574C146.349 139.574 149.864 142.415 147.023 145.929C144.181 149.444 140.671 145.897 140.671 145.897L123.118 128.163" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                        <path d="M55.4297 60.975C55.4297 60.975 53.3125 60.2693 51.1952 62.3866C48.1427 65.4392 51.901 68.7383 51.901 68.7383L70.9562 87.7935C70.9562 87.7935 67.2095 85.0118 63.8987 84.9705C61.1131 84.9358 58.488 87.0878 58.9585 88.4993C59.429 89.9108 61.4668 90.069 66.7217 93.4395C71.4481 96.4711 76.8506 102.838 83.6597 104.026C94.1865 105.861 99.8919 99.0855 99.8919 99.0855C99.8919 99.0855 105.538 93.4395 105.538 84.9705C105.538 77.2073 100.598 73.7076 96.3631 68.0325C92.1286 62.3575 90.7171 56.7406 88.5999 57.4463C86.8775 58.0204 85.8213 61.6808 86.4826 64.5038C87.3093 68.0325 91.4229 72.9728 91.4229 72.9728L70.9562 51.8004C70.9562 51.8004 68.1332 48.2717 64.6044 51.0946C61.0757 53.9176 64.6044 57.4463 64.6044 57.4463" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M77.3079 70.1497L60.3699 53.2118C60.3699 53.2118 57.5469 49.683 54.0182 52.506C50.4894 55.329 54.0182 58.8578 54.0182 58.8578L71.6619 76.5015" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                        <path d="M61.4393 144.475C61.4393 144.475 60.7444 146.595 62.8725 148.702C65.9407 151.739 69.2205 147.964 69.2205 147.964L88.178 128.811C88.178 128.811 85.4155 132.572 85.3911 135.883C85.3706 138.669 87.536 141.283 88.9451 140.805C90.3542 140.327 90.502 138.289 93.8456 133.017C96.8529 128.275 103.193 122.84 104.345 116.025C106.127 105.489 99.3217 99.818 99.3217 99.818C99.3217 99.818 93.6469 94.201 85.1781 94.2443C77.4149 94.2841 73.9406 99.2421 68.2873 103.506C62.634 107.769 57.0244 109.209 57.7409 111.323C58.3238 113.042 61.9896 114.08 64.8091 113.404C68.3336 112.559 73.2527 108.421 73.2527 108.421L52.1853 128.995C52.1853 128.995 48.6711 131.836 51.5121 135.351C54.353 138.865 57.8637 135.318 57.8637 135.318" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M70.5015 122.55L53.6505 139.574C53.6505 139.574 50.1362 142.415 52.9772 145.929C55.8183 149.444 59.3289 145.897 59.3289 145.897L76.8821 128.163" stroke="white" strokeWidth="3" strokeLinecap="square" strokeLinejoin="round" />
                      </svg>
                    </div>
                    <div className='info'>
                      <span className='label'><b className='blue'>Kasaganahan</b> <i>Good for Progress</i></span>
                      <div className='text'>
                        <p>4. At least 15 million people uplifted by 2030</p>
                      </div>
                    </div>
                  </div>
                </div>
